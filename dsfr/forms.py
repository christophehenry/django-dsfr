...
class BoundField(DjangoBoundField):
    ...
    def template_name(self):
        template_name = self.field.template_name or getattr(self.field.__class__, "template_name", None)
        if template_name:
    ...
    if django.VERSION < (5, 2):
        def __getitem__(self, name):
            ...
            if name not in self._bound_fields_cache:
                bound_field_class = getattr(self, "bound_field_class", self.bound_field_class)
